(function () {
	...
	var divFecha= document.getElementById("motivos-fecha");
	divFecha.innerHTML = getFecha();
...
function getFecha(){
   ...
   var f = new Date();
   var rtnFecha = f.getDate() + " de " + meses[f.getMonth()] + " de " + f.getFullYear();
console.log(rtnFecha);
   return rtnFecha;
}	
